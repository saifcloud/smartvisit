                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="body">
                                <form id="basic-form" method="post" action="{{ url('admin/clinical-update-post')}}" enctype="multipart/form-data">@csrf

                                <input type="hidden" name="update_id" value="{{ base64_encode($clinicupdate->id) }}">

                                    <div class="card p-3">

                                        <div class="form-group col-sm-12 d-flex justify-content-center"> <img
                                        src="{{ url('/').$clinicupdate->image
                                    ...
                                    <div class="row col-sm-12">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label>Title</label>
                                            <input type="text" class="form-control" name="title" value="{{ $clinicupdate->title }}">@if($errors->has('title'))
                                            <p class="text-danger">{{ $errors->first('title') }}</p>@endif</div>
                                    ...
                                    <div class="row col-sm-12">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <textarea class="form-control" name="description"  id="description">{!! $clinicupdate->description !!}</textarea>
                                                @if($errors->has('description'))
                                            <p class="text-danger">{{ $errors->first('description') }}</p>@endif</div>
