            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ url('admin/product/update')}}" novalidate>
                               @csrf
                              
                                <input type="hidden" name="pid" value="{{ base64_encode($product->id)}}">
                                <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number"   class="form-control" name="quantity"  oninput="this.value=this.value.replace(/[^0-9]/g,'');"  value="{{ $product->quantity }}" readonly="">
                             ...
                             <div class="row col-sm-12">
                                      ...
                                      <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" step="1" min="1" class="form-control" name="buying_price"  value="{{ $product->buying_price }}" readonly="">
                                       ...
                                       <div class="form-group col-sm-4">
                                        <label>Total</label>
                                        <input type="text" step="1" min="1" class="form-control"  readonly="" id="addptp" value="{{ $product->total_amount }}">
                                        <!--  @if($errors->has('buying_price'))
                                        <p class="text-danger">{{ $errors->first('buying_price') }}</p>
                                        @endif -->
                                    </div>
