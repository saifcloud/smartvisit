            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ url('admin/client/store')}}" novalidate>
                               @csrf
                                ...
                                <div class="row col-sm-12">
                                 ...
                                 <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label>Phone</label>
                                        <input type="number" class="form-control" name="phone" value="{{ old('phone')}}" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                        @if($errors->has('phone'))
